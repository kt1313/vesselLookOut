...
public List<String> listOfVesselsNames = new ArrayList<>();
public List<String> listOfVesselsIMOs = new ArrayList<>();

    //metoda tworzy liste nazw statkow z nr IMO na podstawie podanej nazwy
    static public List<ListOfVessels> getVslsList(String vslName) throws IOException {
